...
$(document).ready(function () {
    ...
    database.ref().on("child_added", function (childSnapshot) {
        ...
        // console.log("------------------------ ----");
        console.log("qm.js child_added");

        // Store everything into our master questions array.
        var q = childSnapshot.val();
        // questions.push(q);

        // Display a subset of our questions to the screen
        var trvNum = q.id;
        var trvCategory = q.category;
        var trvGrade = q.grade;
        var trvQuestion = q.question;
        ...
        var newRow = $("<tr>").append(
            ...
            $("<td>").text(trvCategory),
            $("<td>").text(trvGrade),
            $('<td id="td-question">').text(trvQuestion)
        );

        // Append the new row to the table
        $("#trivia-table > tbody").append(newRow);
    });
});
...
var questionArchive = [
...

    {
        ...
        category: "Georgraphy",
        grade: "3rd Grade",
        question: "How many Great Lakes are there that border the US and/or Canada?",
        answers: ["1", "3", "4", "5"],
        answer: 3,
        splash: "assets/images/geography.webp"
    },
...

    {
        ...
        answers: ["Arachnids", "Amphibians", "Crustaceans", "Mammals"],
        answer: 1,
        splash: "assets/images/science.webp"
    },
